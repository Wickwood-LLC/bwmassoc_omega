...
function bwmassoc_omega_preprocess_page(&$vars)
{
    ...
    else if ((in_array(request_path(), array('biweekly-calculator/access-registration', 'biweekly-calculator/access-registration?submitted=1', 'referral-registration', 'referral-registration?submitted=1', '?submitted=1'))) || empty(arg(0))) {
